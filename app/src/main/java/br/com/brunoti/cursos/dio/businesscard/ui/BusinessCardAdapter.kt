...
import br.com.brunoti.cursos.dio.businesscard.databinding.ItemBusinessCardBinding
...
class BusinessCardAdapter :
    ...
    inner class ViewHolder(
        ...
        fun bind(item: BusinessCard) {
            ...
            binding.tvNome.setTextColor(item.fontPersonalizado.toInt())
            binding.tvEmail.setTextColor(item.fontPersonalizado.toInt())
